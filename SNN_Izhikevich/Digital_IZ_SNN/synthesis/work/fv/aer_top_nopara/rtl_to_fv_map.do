...
# Generated on: Tue Apr 08 15:43:31 EDT 2025 (Tue Apr 08 19:43:31 UTC 2025)
...
set logfile fv/aer_top_nopara/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/aer_top_nopara -revised fv_map
...
add_search_path /export/tsmc/TSMC_IP/standard_cell_65GP/lib -library -both
read_library -liberty -both \
    /export/tsmc/TSMC_IP/standard_cell_65GP/lib/tcbn65gplustc.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../source/aer_encoder_no_arbiter.v ../../source/aer_micropipeline.v ../../source/MCEL.v ../../source/aer_top_nopara.v
elaborate_design -golden -root {aer_top_nopara} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/aer_top_nopara/fv_map.v.gz
elaborate_design -revised -root {aer_top_nopara}
...
#add_name_alias fv/aer_top_nopara/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.aer_top_nopara.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.aer_top_nopara.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.aer_top_nopara.rtl.fv_map.rpt
