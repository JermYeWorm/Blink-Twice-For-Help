...
# Generated on: Tue May 20 12:28:23 EDT 2025 (Tue May 20 16:28:23 UTC 2025)
...
set logfile fv/snn_fixed_16_2_4_4_2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/snn_fixed_16_2_4_4_2 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86"
set env(CW_DIR) "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/afs/glue.umd.edu/department/enee/software/cadenceIC23/installs/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
read_library -liberty -both -lp all \
    /afs/glue.umd.edu/home/glue/y/i/yihuiw/home/course/ENEE408D_S25/project/SNN/IZ_snn/synthesis/work/../../lib/scs130lp_tt_1.62_25_nldm.lib
...
add_search_path ../../source -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../source/fixed_16_synapse.v ../../source/IZ_pipeline_16.v ../../source/snn_fixed_16_2_4_4_2.v
elaborate_design -golden -root {snn_fixed_16_2_4_4_2} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/snn_fixed_16_2_4_4_2/fv_map.v.gz
elaborate_design -revised -root {snn_fixed_16_2_4_4_2}

uniquify -all -nolib -golden

read_power_intent -insert_isolation -1801 -golden ../scripts/upf
read_power_intent -1801 -revised fv/snn_fixed_16_2_4_4_2/fv_map.upf
...
#add_name_alias fv/snn_fixed_16_2_4_4_2/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.snn_fixed_16_2_4_4_2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.snn_fixed_16_2_4_4_2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.snn_fixed_16_2_4_4_2.rtl.fv_map.rpt
